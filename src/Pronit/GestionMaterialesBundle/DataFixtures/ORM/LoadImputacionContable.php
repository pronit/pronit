...
use Pronit\GestionMaterialesBundle\Entity\Customizing\Contabilidad\ImputacionContable;
...
class LoadImputacionContable extends AbstractFixture implements FixtureInterface, OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        foreach( $values as $value ){
            $categoriaValoracion = $this->getReference('pronit-gestionmateriales-categoriavaloracion-' . $value['categoriaValoracion']);
