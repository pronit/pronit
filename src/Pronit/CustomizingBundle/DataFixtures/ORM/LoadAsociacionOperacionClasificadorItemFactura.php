 ...
 * @author gcaseres
 */
class LoadAsociacionOperacionClasificadorItemFactura extends AbstractFixture implements FixtureInterface , OrderedFixtureInterface, ContainerAwareInterface
{
    /**
