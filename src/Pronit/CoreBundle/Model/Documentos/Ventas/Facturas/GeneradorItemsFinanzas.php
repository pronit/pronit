...
namespace Pronit\CoreBundle\Model\Documentos\Ventas\Facturas;
...
class GeneradorItemsFinanzas implements IGeneradorItemsFinanzas {
    ...
    protected function generarParaCondicionPagos(Factura $documento) {
        ...
        $claseDocumento = $this->em->getRepository('Pronit\CoreBundle\Entity\Documentos\ClaseDocumento')->find(ClaseDocumento::CODIGO_FACTURADEUDOR);
